...
@Composable
internal fun GeoResultContent(
    modifier: Modifier = Modifier,
    geoResult: BarcodeResult.Geo,
    ...
    Box(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = geoResult::class.java.simpleName,
                ...
                Text(
                    text = geoResult.lat.toString() + "," + geoResult.lng.toString(),
                ...
                ActionButtonsLayout(
                    share = "${geoResult::class.java.simpleName}: ${geoResult.lat.toString() + "," + geoResult.lng.toString()}",
                    copyToClipboard = geoResult.lat.toString() + "," + geoResult.lng.toString(),
                    onAction = onAction
                )
            }
        }
